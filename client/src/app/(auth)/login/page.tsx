...
export const metadata: Metadata = {
  title: "Sign in — Gold Cloud",
  description: "Access your secure Gold Cloud file workspace.",
};
      ...
      <section className="relative hidden flex-col justify-between overflow-hidden bg-slate-950 p-10 text-white lg:flex xl:p-14">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-slate-300">
            Store, access, and share your files securely — all from one
            encrypted workspace built for speed.
          </p>
